...
import HomeIconSvg from "../assets/home-icon-fixed.svg";
import FeedIconSvg from "../assets/feed-icon.svg";
import ProfileIconSvg from "../assets/profile-icon.svg";
import NotificationIconSvg from "../assets/notif-icon.svg";
import LogoSvg from "../assets/logo.svg";
import ChallengeIconSvg from "../assets/challenge-icon.svg";
import LevelIconSvg from "../assets/level-icon.svg";
    ...
    >
      <div>
        <div className="p-4 flex items-center space-x-3">
          ...
          />
          <h2 className="pl-1 text-xl font-semibold" style={{ color: "#6B7280" }}>
            John's Life
          </h2>
        </div>
        ...
        <div className="px-4 py-2 space-y-8 mt-6">
          {/* Daily Challenges */}
          <div
            className="bg-white rounded-lg p-4 shadow-sm mx-auto"
      ...
      <div className="p-4">
        <button
          className="w-full text-white py-3 px-4 rounded-md cursor-pointer flex items-center justify-center space-x-2 transition-colors"
          style={{
            backgroundColor: "#9D00FF",
            ":hover": { backgroundColor: "#8A00E6" },
          }}
          onMouseEnter={(e) => (e.target.style.backgroundColor = "#8A00E6")}
          onMouseLeave={(e) => (e.target.style.backgroundColor = "#9D00FF")}
        >
