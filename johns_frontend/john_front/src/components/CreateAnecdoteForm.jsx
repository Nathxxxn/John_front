        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg">
              ...
              <Link
                to="/tips"
                className="block w-full bg-blue-50 hover:bg-blue-100 text-blue-600 text-center py-2 px-4 rounded-lg font-medium transition-colors"
              >
                View More Tips
              </Link>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg">
              ...
              <Link
                to="/explore"
                className="w-full block bg-blue-50 hover:bg-blue-100 text-blue-600 py-2 px-4 rounded-lg font-medium transition-colors cursor-pointer text-center"
              >
                Explore Anecdotes
              </Link>
            </div>
